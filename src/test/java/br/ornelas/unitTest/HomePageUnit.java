...
///////////////////////////////////////////////////////////////////////
		...
		// Campo E-mail
		navegador.findElement(By.id("email")).sendKeys("teste@teste.com.com");

		// Campo Phone
		navegador.findElement(By.id("phone")).sendKeys("11999999999");
...
///////////////////////////////////////////////////////////////////////
		...
		WebElement telaFinal = navegador.findElement(By.xpath("//h2[contains(text(),'Sending e-mail success!')]"));
